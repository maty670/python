...
with open('Curso-Python\\03-Modulos\\carpeta\\archivo_creado.txt','w',encoding="UTF-8") as archivo:
    archivo.write(f"""Ejemplo de texto
prueba
escrito en el txt
""")
    
# Con el parametro 'w' se crea el archivo y se sobreescibe su contenido
with open('Curso-Python\\03-Modulos\\carpeta\\archivo_creado2.txt','w',encoding="UTF-8") as archivo:
...
# reemplazar por 'a'
with open('Curso-Python\\03-Modulos\\carpeta\\archivo_creado3.txt','a',encoding="UTF-8") as archivo:
    for i in range(0,5):
